...
\usepackage[dvipdfmx,bookmarks=true,bookmarksnumbered=true,colorlinks=true,%
     pdftitle={スパムにされないメール設定方法},%
     pdfauthor={さっぴー川原}]{hyperref}
...
%%%
\title{スパムにされないメール設定方法}
\makeatletter
\def\@subtitle{御社のメール設定は大丈夫ですか？\\
メール送信して届いていないと言われたことありませんか？\\
その問題は、実はメール設定にあったのです！}
\def\@pubevent{技術書同人誌博覧会（2019年夏）新刊}
\def\@latestpubhistory{2019年7月27日　ver 1.0}
\makeatother
\author{さっぴー川原　著}
\date{2019{-}07{-}27 版\hspace{2zw} 発行}
%%%
\begin{titlepage}
...
\begin{center}%
  \mbox{} \vskip5zw
   \reviewtitlefont%
    {\HUGE\bfseries スパムにされないメール設定方法 \par}%
    \vskip 1em%
    {\Large {\rmfamily --- } 御社のメール設定は大丈夫ですか？
メール送信して届いていないと言われたことありませんか？
その問題は、実はメール設定にあったのです！ {\rmfamily --- } \par}%
    \vskip 15em%
    {\LARGE
      \lineskip .75em
      \begin{tabular}[t]{c}%
      ...
      \end{tabular}\par}%
    \vfill
    {\large 2019{-}07{-}27 版\hspace{2zw} 発行\par}%
\vskip4zw\mbox{}
  \end{center}%
  \fi                    %%%%%%%%%%
\end{titlepage}
...
\mainmatter
\input{chap01-starter.tex}
\input{chap02-faq.tex}
...
{\noindent\reviewtitlefont\Large スパムにされないメール設定方法} \\
\medskip
{\noindent\reviewtitlefont 御社のメール設定は大丈夫ですか？
メール送信して届いていないと言われたことありませんか？
その問題は、実はメール設定にあったのです！} \\
